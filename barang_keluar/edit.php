...
if(isset($_POST['edit'])){
    ...
    $jumlah=$_POST['jumlah'];
    $sql=mysqli_query ($koneksi,"UPDATE barang_keluar SET id_barang='$id_barang', id_admin='$id_admin', nama_admin='$nama_admin', jumlah='$jumlah'  WHERE id_keluar='$id_keluar'" ) or die($koneksi);
    if ($sql){
        echo"
            <script> 
