...
<h2>Barang Keluar</h2>
        <div class="col">
            ...
            <input type="text" name="id_keluar" value="<?php echo $r['id_keluar']?>" class="form-control" readonly>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tangggal_keluar" value="<?php echo $r['tanggal_keluar']?>" class="form-control" readonly>
        </div>
        <div class="mb-3">
